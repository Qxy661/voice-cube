...
AI_PRESETS = {
    ...
    "lazy_goat_ai": {
        "name": "懒羊羊(AI)",
        "icon": "🐑",
        "description": "懒羊羊的可爱声线 (DSP 模拟, RVC 模型需自行训练或从 klrvc.com 获取)",
        "category": "ai",
        "model_path": None,
    },
    "bear_two_ai": {
        "name": "熊二(AI)",
        "icon": "🐻",
        "description": "熊二的憨厚声线 (DSP 模拟, RVC 模型需自行训练)",
        "category": "ai",
        "model_path": None,
    },
    "belial_ai": {
        "name": "贝利亚(AI)",
        "icon": "👹",
        "description": "贝利亚的威严声线 (DSP 模拟, RVC 模型需自行训练)",
        "category": "ai",
        "model_path": None,
    },
    "mambo_ai": {
        "name": "曼波(AI)",
        "icon": "🐧",
        "description": "曼波的活泼声线 (RVC PyTorch 推理, 来自赛马娘 Matikane Tannhauser)",
        "category": "ai",
